    ...
    <MarketplaceLayout>
      <div className="container py-16 max-w-sm">
        ...
        <form className="mt-6 space-y-4">
          ...
          <div><label className="text-sm font-medium mb-1 block">Téléphone</label><input type="tel" className="w-full h-10 px-3 rounded-md border bg-background text-sm" placeholder="+213 5 XX XX XX XX" /></div>
