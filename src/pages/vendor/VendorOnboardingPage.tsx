    ...
    <MarketplaceLayout>
      <div className="container py-12 max-w-2xl">
        <div className="text-center mb-8">
          ...
          <p className="text-sm text-muted-foreground mt-1">En quelques minutes, commencez à vendre sur Marché</p>
        </div>
        ...
        <div className="bg-card rounded-lg border p-6 space-y-4">
          {step === 0 && (
            <>
              ...
              <div><label className="text-sm font-medium mb-1 block">Catégorie principale</label><select className="w-full h-10 px-3 rounded-md border bg-background text-sm"><option>Mode</option><option>Maison</option><option>Artisanat</option></select></div>
            </>
          )}
          {step === 1 && (
            <>
              ...
              <div className="grid grid-cols-2 gap-3">
                {["Produits physiques", "Produits digitaux", "Services", "Artisanat"].map(t => (
          ...
          {step === 2 && (
            <>
              ...
              <div><label className="text-sm font-medium mb-1 block">IBAN</label><input className="w-full h-10 px-3 rounded-md border bg-background text-sm" placeholder="FR76 XXXX XXXX XXXX" /></div>
