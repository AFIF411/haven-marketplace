...
/**
 * Sélecteur de rôle rapide — 3 rôles : Client, Vendeur, Admin.
 * Permet de basculer d'un espace à l'autre sans se reconnecter.
 */
      ...
      {open ? (
        <div className="w-60 rounded-lg border bg-card shadow-lg p-3">
          <div className="flex items-center justify-between mb-3">
            <span className="text-xs font-semibold text-muted-foreground">Changer de rôle</span>
